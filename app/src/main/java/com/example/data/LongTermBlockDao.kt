...
interface LongTermBlockDao {
    ...
    @Query("UPDATE long_term_blocks SET usedSecondsToday = :usedSeconds, usedMillisToday = :usedMillis, lastUsageResetEpochDay = :epochDay WHERE id = :id")
    suspend fun updateUsage(id: Int, usedSeconds: Long, usedMillis: Long, epochDay: Long)
